...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        {
            addressBuilder.Property(a => a.FirstName).HasMaxLength(50)
                                                        .IsRequired();

            addressBuilder.Property(a => a.LastName).HasMaxLength(50)
                                                    .IsRequired();
        ...
        builder.ComplexProperty(o => o.Payment, paymentBuilder =>
        {
            ...
            paymentBuilder.Property(p => p.CardNumber).HasMaxLength(24)
                                                      .IsRequired();
